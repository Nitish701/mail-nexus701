...
def list_reports(db: Session, report_type: str | None = None, limit: int = 50, offset: int = 0) -> list[dict[str, Any]]:
...
def get_report(db: Session, report_id: str) -> dict[str, Any] | None:
