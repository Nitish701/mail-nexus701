  ...
  return (
    ...
    >
      <section style={{ background: '#111827', borderRadius: 16, padding: 24, border: '1px solid #243b5b' }}>
        <h2 style={{ margin: '0 0 16px', fontSize: 22 }}>Tenant monitoring</h2>
        <div style={{ color: '#9fb5d8', padding: '24px 0 8px' }}>No organization tenants are currently connected.</div>
      </section>
    </AppShell>
  );
}
